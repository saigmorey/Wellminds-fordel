...
def do_admin_login():
    if request.form['password'] == 'final' and request.form['username'] == 'project':
...
@app.route("/situation_based")
def situation_based():
    return render_template("situation_based.html")

@app.route("/result_health")
def result_health():
    return render_template("result_health.html")

@app.route("/result_stress")
def result_stress():
    return render_template("result_stress.html")
